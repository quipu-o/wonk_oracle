...
2. They have candidates on the ground who can step up to claim power. We just haven't seen them.
...
3. Continuous attempts to decapitate the IRGC and hardliners, possibly with commandos
   (maybe Israeli ones, so the US can pretend this is not Iraq). Attempt negotiations again.
4. Miraculously locals find a lot of weapons, attempts at overthrowing the (local) government
   in certain cities/regions. Civil war like split up. Syria 2.0 with different starting conditions.
5. Something that involves US troops on the ground.
6. Some total fuck-up scenario of Iran blowing up a dirty bomb somewhere.
